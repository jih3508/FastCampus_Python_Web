...
# sqlite3
print('sqlite3.versiont : ', sqlite3.version)
print('sqlite3.sqlite_version: ', sqlite3.sqlite_version)

# DB 생성 & Auto Commit(Rollback)
conn = sqlite3.connect('./section12/resource/database.db', isolation_level=None)
...
# 데이터 삽입
c.execute("INSERT INTO users VALUES(1, 'Kim', 'Kim@namver.com', '010-0000-0000', 'Kim.com', ?) ", (nowDatetime,))
